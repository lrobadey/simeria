...
- **Adapa**, the first human — hunger, sleep, an inventory, and no script.
  He forages dates, rhizomes and seed grass, cuts reeds, gathers deadwood,
  *chooses* a shelter site by scoring real tiles (dry feet, fresh water,
  food in reach, raised against the flood), builds a mudhif-style reed
  house, and lights a hearth that burns the wood he actually gathered.
...
- Stuck-detection matters more than pathfinding: on a delta, a straight
  walker dies pressed against a lagoon.
